    ...
    <q-tab-panels v-model="tab" animated>
      <q-tab-panel name="add">
        <div class="row">
          ...
          <div class="col-12 col-md-3">
            <q-input dense stack-label color="primary" v-model="form.suffix" label="Extension"></q-input>
          </div>
          <div class="col-6 col-md-3">
            <q-input v-model="form.birthdate" mask="date" label="Birth Date" stack-label dense>
          ...
          <div class="col-6 col-md-3">
            <q-select
              ...
              stack-label
              lazy-rules
              :rules="[val => val !== null && val !== '' || 'Please select a gender',]"
            />
          </div>
          <div class="col-6 col-md-3">
            <q-input
              ...
              :rules="[val => val !== null && val !== '' || 'Please input purok',]"
              stack-label
              ref="purok"
          ...
          <div class="col-6 col-md-6">
            <q-select
              ...
              stack-label
              lazy-rules
              :rules="[val => val !== null && val !== '' || 'Please select a relationship',]"
            />
          </div>
          <div class="col-6 col-md-6">
            <q-input
          ...
          <div class="col-12 col-md-12 text-right">
            <q-btn @click="save" :loading="loading" outline color="primary" label="Save" />
          </div>
        </div>
      </q-tab-panel>
      <q-tab-panel name="list">
        <div>
          <div class="text-center">
            <q-input dense outlined v-model="datax.rep_address" :readonly="!read" label="Purok">
              <template v-slot:append>
                ...
                <div class="col-auto">
                  <q-btn color="grey-7" size="xs" round flat icon="more_vert">
                    <q-menu cover auto-close>
                      <q-list>
                        <q-item clickable>
                          <q-item-section @click="printCard(props.row)">Print Card</q-item-section>
                        </q-item>
                        <q-item clickable>
                          <q-item-section @click="viewmember(props.row)">View Member</q-item-section>
                        </q-item>
                      </q-list>
                    </q-menu>
                  </q-btn>
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                <!-- <q-td key="prefix" :props="props">
                  {{ props.row.prefix }}
                  <q-popup-edit v-model="props.row.prefix" buttons>
                    <q-input
                ...
                <q-td key="lastName" :props="props">
                  {{ props.row.lastName }}
                  <q-popup-edit v-model="props.row.lastName" title="last Name" buttons>
                    <q-input v-model="props.row.lastName" dense autofocus counter buttons />
                  </q-popup-edit>
                </q-td>

                <q-td key="firstName" :props="props">
                  {{ props.row.firstName }}
                  <q-popup-edit v-model="props.row.firstName" title="First Name" buttons>
                    <q-input v-model="props.row.firstName" dense autofocus />
                  </q-popup-edit>
                </q-td>
                <q-td key="middleName" :props="props">
                  {{ props.row.middleName }}
                  <q-popup-edit v-model="props.row.middleName" title="Middle Name" buttons>
                ...
                <q-td key="suffix" :props="props">
                  {{ props.row.suffix }}
                  <q-popup-edit v-model="props.row.suffix" title="Suffix" buttons>
                    <q-input v-model="props.row.suffix" dense autofocus counter buttons />
                  </q-popup-edit>
                </q-td>
                <q-td key="birthdate" :props="props">
                  {{ props.row.birthdate }}
                  <q-popup-edit v-model="props.row.birthdate" title="Birthdate" buttons>
                    <!-- <q-input
                ...
                <q-td key="gender" :props="props">
                  {{ props.row.gender }}
                  <q-popup-edit v-model="props.row.gender" title="Gender" buttons>
                    <q-select
                      ref="relation"
                ...
                <q-td key="member_type" :props="props">
                  ...
                  <q-popup-edit v-model="props.row.member_type" title="Relation" buttons>
                    <q-select
                      ref="relation"
                ...
                <q-td key="rep_address" :props="props">{{ props.row.rep_address }}</q-td>
