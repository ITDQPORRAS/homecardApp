  ...
  <div class="q-pa-sm">
    <q-card>
        ...
        <q-form ref="contentheader">
          <div class="row"> 
            <div class="col-6 col-md-6 q-pt-sm">
              <q-input ref="Name" v-model="main.name" dense label="Name" :readonly="readonly"
                lazy-rules
                :rules="[val => (val !== null && val !== '') || 'Required']"/>
            </div>
            <div class="col-6 col-md-6 q-pt-sm">
              <q-input v-model="main.created" readonly dense label="Created Date" />
            </div>
            <div class="col-12 col-md-12 q-pt-sm">
              <q-input ref="Email" label="Email" v-model="main.email" dense :readonly="readonly"
                lazy-rules
                :rules="[val => (val !== null && val !== '') || 'Required']"/>
            </div> 
          </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-12 q-pb-sm q-pt-sm">
                ...
                <template v-slot:header-cell-Read="props">
                  <q-th :props="props">
                    <q-checkbox bottom-label label="Read" size="xs" dense v-model="chkallRead" />
                  </q-th>
                </template>
                <template v-slot:header-cell-Write="props">
                  <q-th :props="props">
                    <q-checkbox bottom-label label="Edit" size="xs" dense v-model="chkallWrite" />
                  </q-th>
                </template>
                <template v-slot:header-cell-Create="props">
                  <q-th :props="props">
                    <q-checkbox bottom-label label="Create" size="xs" dense v-model="chkallCreate" />
                  </q-th>
                </template>
                <template v-slot:header-cell-Delete="props">
                  <q-th :props="props">
                    <q-checkbox bottom-label label="Delete" size="xs" dense v-model="chkallDelete" />
                  </q-th>
                </template>
                <template v-slot:body-cell-Read="props">
                  <q-td :props="props">
                    <q-checkbox size="xs" true-value="1" false-value="0" dense v-model="props.row.Read" />
                  </q-td>
                </template>
                <template v-slot:body-cell-Write="props">
                  <q-td :props="props">
                    <q-checkbox size="xs" true-value="1" false-value="0" dense v-model="props.row.Write" />
                  </q-td>
                </template>
                <template v-slot:body-cell-Create="props">
                  <q-td :props="props">
                    <q-checkbox size="xs" true-value="1" false-value="0" dense v-model="props.row.Create" />
                  </q-td>
                </template>
                <template v-slot:body-cell-Delete="props">
                  <q-td :props="props">
                    <q-checkbox size="xs" true-value="1" false-value="0" dense v-model="props.row.Delete" />
                  </q-td>
                </template>
                </q-table>
              </div>
      ...
      <div class="col-12 q-pa-sm">
        <command @save="saveValidation" @clear="clearall" :disable="disable" :labelSave="main.userid >0 ?'Update':'Save'" />
      </div>
    </q-card>
  </div>
</template>
